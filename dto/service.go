...
type ServiceListItemOutput struct {
	...
	ServiceName string `form:"service_name" json:"service_name" ` //服务名称
	ServiceDesc string `form:"service_desc" json:"service_desc" ` //服务描述
	LoadType int `form:"load_type" json:"load_type" `			//服务类型
	ServiceAddr string `form:"service_addr" json:"service_addr" ` //服务地址
	Qps int64 `form:"qps" json:"qps" `							//qps
	Qpd int64 `form:"qpd" json:"qpd" `							//qpd
	TotalNode int64 `form:"total_node" json:"total_node" `		//节点数

}

type ServiceListOutput struct {
	Total int64 `form:"total" json:"total" comment:"总数" example:"" validate:""`
	List []ServiceListItemOutput `form:"list" json:"list" comment:"列表" example:"" validate:"required"`


}

type ServiceDeleteInput struct {
	ID int64 `form:"id" json:"id" example:"20" validate:"required"`
}
...
type ServiceDetailInput struct {
	ID int64 `form:"id" json:"id" example:"60" validate:"required"`
}
//判断参数是否出错
...
type ServiceStatOutput struct {
	Today     []int64                   `form:"today" json:"today" comment:"今天数据" example:"" validate:""`
	Yesterday []int64 `form:"yesterday" json:"yesterday" comment:"昨天数据" example:"" validate:""`
